            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="jacket_id" placeholder="Enter your produk ID" data-toggle="m-tooltip" title="Input Produk ID">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control m-input" name="jacket_name" placeholder="Enter your product name">
                        </div>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="m-input-icon m-input-icon--left">
                            <input type="text" class="form-control m-input" name="jacket_price" placeholder="Enter digits">
