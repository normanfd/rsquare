                    ...
                    <div class="m-widget4">
                        <div class="m-widget4__item">
                            <div class="m-widget4__img m-widget4__img--pic">
                                <img src="../storage/{{ $produk->jacket_image }}" alt="" width="50" height="50">
                            </div>
                            <div class="m-widget4__info">
                                ...
                                <span class="m-widget4__sub">
                                    harga produk : {{ $produk->jacket_price }}
                                </span>
                            </div>
                            <div class="m-widget4__ext" style="padding-right:10px;">
                                <a href="{{ route('admin.Editcustomjacket', $produk->id)}}" class="m-btn m-btn--hover-brand btn btn-sm btn-primary">Edit</a>
                            </div>
